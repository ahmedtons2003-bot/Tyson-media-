        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex h-16 items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <Link
                href="/cart"
                className="rounded-xl border px-3 py-2 text-sm font-black transition hover:bg-[#f5f1ec]"
              >
                🛒
              </Link>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
          {categories.map((category) => (
            <Link
              key={category.title}
              href={category.href}
              className="group relative overflow-hidden rounded-3xl border bg-white p-5 transition duration-200 hover:-translate-y-1 hover:shadow-xl"
            >
              ...
              {category.active ? (
                ...
                <div className="mt-5 inline-flex rounded-full bg-[#f3eee8] px-3 py-1 text-xs font-black text-[#8a8178]">
                  قريبًا
                </div>
              )}
            </Link>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          >
            ...
            <p className="mt-2 text-sm leading-6 text-gray-500">
              أفراح، خطوبة، جلسات وتصوير مناسبات.
            </p>

            <div className="mt-5 font-black text-[#b87333]">
              دخول التصوير ←
            </div>
          </Link>
          ...
          >
            ...
            <p className="mt-2 text-sm leading-6 text-gray-500">
              زينة سيارات، ديكور وتجهيز للمناسبات.
            </p>
          ...
          >
            ...
            <p className="mt-2 text-sm leading-6 text-gray-500">
              منتجات يدوية من بائعين مختلفين.
            </p>
