...
const categories = [
  { icon: "🤵", name: "بدلات زفاف" },
  { icon: "🕴️", name: "بدلات كلاسيك" },
  { icon: "✨", name: "بدلات سواريه" },
  { icon: "👔", name: "بدلات رسمية" },
  { icon: "🧵", name: "تفصيل" },
  { icon: "👞", name: "إكسسوارات" },
];
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] bg-[#211f1c] px-6 py-16 text-white md:px-12 md:py-24">
          ...
          <div className="relative max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-sm leading-8 text-white/60">
              اكتشف أفضل البدلات لمناسبتك،
              من بدلات الزفاف والكلاسيك إلى
              البدلات الرسمية والتفصيل.
            </p>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <select className="w-full rounded-2xl border bg-white p-3 outline-none focus:border-[#b87333]">
                <option>كل البدلات</option>
                <option>بدلات زفاف</option>
                <option>بدلات كلاسيك</option>
                <option>بدلات سواريه</option>
                <option>بدلات رسمية</option>
                <option>تفصيل</option>
              </select>
            </div>
          ...
          <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-7 text-[#746f68]">
                ...
                المناسبة بـ30 يومًا على الأقل
                لضمان وقت كافي للاختيار والتجهيز.
              </p>
            </div>
