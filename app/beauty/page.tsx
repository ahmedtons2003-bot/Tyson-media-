...
const categories = [
  { icon: "💄", name: "ميكاب" },
  { icon: "💇‍♀️", name: "تصفيف شعر" },
  { icon: "💅", name: "أظافر" },
  { icon: "✨", name: "عناية بالبشرة" },
  { icon: "👰", name: "تجهيز عرائس" },
  { icon: "💆‍♀️", name: "سبا وعناية" },
];
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] bg-[#211f1c] px-6 py-16 text-white md:px-12 md:py-24">
          ...
          <div className="relative max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-sm leading-8 text-white/60">
              اكتشفي خبراء الميكاب والشعر
              والأظافر وتجهيز العرائس وكل خدمات
              الجمال لمناسبتك.
            </p>
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="mt-3 text-sm leading-7 text-[#746f68]">
                  خدمة احترافية لتجهيزك وإطلالتك
                  في مناسبتك الخاصة.
                </p>
          ...
          <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-7 text-[#746f68]">
                ...
                علشان تضمني موعدك وتجهيزك براحة.
              </p>
            </div>
